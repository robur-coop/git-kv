...
struct
  ...
  let connect ctx =
    ...
    let k2
        ...
        git_uri
        git_http_headers
        git_mirage_http_headers
        git_mirage_http_tls_config =
      ...
      Mimic.fold Git_store.Endpoint.git_transmission
        Mimic.Fun.
          [
            ...
            req Git_store.Endpoint.git_scheme; req Git_store.Endpoint.git_uri;
            dft Git_store.Endpoint.git_http_headers List.[];
